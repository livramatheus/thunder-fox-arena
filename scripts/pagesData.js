const getPagesData = () => {
    return {
        ...
        <p>
            Thunder Fox Arena is an open source project. Be free to open new issues or Merge Requests in order to 
            improve the project.
            Check out the <a target="_blank" href="https://github.com/livramatheus/thunder-fox-arena">GitHub 
            repository</a>.
        </p>
    
        `,
        'info-legal': `
        <h2>Legal - Information to Taito</h2>
